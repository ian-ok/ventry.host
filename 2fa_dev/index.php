...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        $factusername = $row["username"];
    }
} else {
    echo "0 results";
}

$qrCodeUrl = $Authenticator->getQR('M. Hills | File Host (' . $factusername . ')', $_SESSION['auth_secret']);
         ...
         <br>   
                    ...
                    <div style="text-align: center;">
                        <?php if ($_SESSION['failed']): ?>
                            <div class='card' <div class='card-body'> <br> <h3 class='card-text' style='color: red;'>Invalid Code!</h3> <br> </div> </div> <br>
                            <?php   
                                $_SESSION['failed'] = false;
                            ?>
                        <?php endif ?>
