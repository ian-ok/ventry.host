...
$('.btn').click(function() {
var oldurl1 = document.getElementById("urlinput").value;
var newurl1 = document.getElementById("shortenedURL").value;
...
document.getElementById("btn").addEventListener("click", shorturl);

console.log(`PLEASE DON'T TYPE ANYTHING BELLOW UNLESS YOU ARE A DEVELOPER!`)
