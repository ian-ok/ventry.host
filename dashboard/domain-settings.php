...
{
    if (isset($_POST['upload_domain']))
    {
        $sql2 = "UPDATE users SET upload_domain='" . $_POST['upload_domain'] . "' WHERE `username`='$username'";
        $result2 = mysqli_query($db, $sql2);
    }

    header("location: https://mhills.de/dashboard/domain-settings");
}
                ...
                <section class="row">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Domain Settings</h4>
                                </div>
                                <div class="card-body px-3 py-4-5">
                                <div class="form-group">
                                    <label style="color: #ccc" for="basicInput">Fake Domain</label>
                                    <input type="text" class="form-control" name="upload_domain" id="upload_domain" data-temp-mail-org="0" placeholder="<?php echo $embed["upload_domain"] ?>" value="<?php echo $embed["upload_domain"] ?>">
                                </div>
