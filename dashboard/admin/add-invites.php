...
">
    ...
    -ms-box-shadow: 0 5px 10px 0px rgba(0, 0, 0, 0.1);" src="<?php echo $row["discord_avatar"] ?>" alt="Face 1">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card" style="width: 400px;">
                                <div class="card-header">
                                    <h4 class="card-title">Add Invites</h4>
                                </div>
                                <div class="card-body px-3 py-4-5">
                                    <?php
                                echo "<form method='get' action='add-invites'><select name='inviteauthor' id='user-select'><option value=''>Choose a User</option>";
            ...
            <input type="invitecode" placeholder="Enter Invite Code" name="invitecode" value="<?php echo $gennedInvite ?>" style="
    background: #131313;
    color: white;
    font-size: 20px;
    border: 0;
...
">
        ...
        <br>
                <hr class='rounded'>
                <br>
                <form method='get' action='add-invites'>
                <button type="submit" name="invitewave" class="btn btn-lg btn-dark">Do Invitewave</button>
                </form>
                                </div>
                            </div>
                        </div>
