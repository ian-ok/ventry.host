...
if(isset($_GET["updateUsername"])){
    ...
    if(strlen($newUsername) >1){
        $sql123 = "UPDATE `users` SET `username`='$newUsername' WHERE `username`='$username'";
        mysqli_query($db, $sql123);
    }
    else{
        header("location: https://mhills.de/dashboard/user");
    }
    header("location: https://mhills.de/dashboard/index.php?logout=%271%27");
}
if (isset($_POST['profile_state']))
    {
        $sql3 = "UPDATE users SET profile_state='true' WHERE username='" . $username . "';";
    ...
    if (!isset($_POST['profile_state']))
    {
        $sql3 = "UPDATE users SET profile_state='false' WHERE username='" . $username . "';";
        $result3 = mysqli_query($db, $sql3);
    }
    if (!isset($_POST['profile_state']))
    {
    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="page-content">
                <section class="row">
                    <div class="col-12 col-lg-9" style="width: -webkit-fill-available;">        
                        <div class="row"style="width: -webkit-fill-available;">
                        <div class="col-6 col-lg-3 col-md-6" style="width: -webkit-fill-available;">
                            <div class="card" style="width: auto;height: auto;">
                                    <div class="card-header">
                                        <h4>User Search</h4> </div>
                                    <div class="card-content pb-4">
                                        <div class='name ms-4'><br>
                                            <form method="GET" action="user">
                                            <div class="form-group">
                                                <label style="color: #ccc" for="basicInput">Username</label>
                                                <input type="text" class="form-control" name="profile" id="basicInput" placeholder="<?php echo $row["username"] ?>" data-temp-mail-org="0"> </div>
                                                <input class="btn btn-lg btn-dark" type="submit" value="Search"></a>
                                                </form>
                                </div>
                            </div>
                        </div>
