                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Your Invites</h4>
                                </div>
                            ...
                            for ($i = 0; $i < $rows21; ++$i) { 
                                ...
                                echo "<tr>
                                <td class='text-bold-500'>". $row21["inviteCode"] . "</td>
                                <td class='text-bold-500'><a href='https://mhills.de/invite/". $row21["inviteCode"] . "'>https://mhills.de/invite/". $row21["inviteCode"] . "</a></td>
                                <td>Never Expires</td>
                            </tr>";
                            }
                        ?>
